...
final class TypedDictionaryTest extends TestCase
{
    ...
    public function testFindFirstKey(): void
    {
        ...
        $dictionary = TypedDictionary::create('int', 'int', [$value1, $value2, $value3, $value4]);
    ...
    public function testIsEmptyWhenItIsNotEmpty(): void
    {
        ...
        $dictionary = TypedDictionary::create('int', 'int', [$value1]);
    ...
    {
        $dictionary = TypedDictionary::create('int', 'int');
    ...
    public function testUniquePreservingKeys(): void
    {
        ...
        self::assertSame($uniqueDictionary, $dictionary);
